        ...
        <div class="row footer-top py-5">
            <div class="col-6 col-md-2 mb-3">
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="#" class="nav-link footer-item p-0 text-body-secondary">MOVIES</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link footer-item p-0 text-body-secondary">CINEMAS</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link footer-item p-0 text-body-secondary">FOOD & DRINKS</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link footer-item p-0 text-body-secondary">EXPERIENCES</a></li>
                </ul>
            </div>
            ...
            <div class="col-6 col-md-2 mb-3">
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="#" class="nav-link footer-item p-0 text-body-secondary">Terms & Conditions</a></li>
        ...
        <div class="container">
            <div class="d-flex flex-column flex-sm-row justify-content-between py-2">
                ...
                <ul class="list-unstyled d-flex mb-0">
                    <li>
                        <a href="#" target="_blank" class="text-white text-uppercase text-decoration-none px-3 py-1">
